                        ...
                        <vs-dropdown-menu class="lg:w-1/4">
                          <div class="vx-row">
                            <div class="vx-col sm:w-full md:w-3/6 lg:w-1/2 xl:w-1/2 mx-auto">
                              <vs-dropdown-item><a href="https://xongl.com/client/index.php/knowledgebase/5" target="_blank">
                                  <p class="py-2 px-2 cursor-pointer hover:bg-primary hover:text-white"><i class="feather icon-help-circle mr-4"></i>How to connect? </p>
                                </a></vs-dropdown-item>
                              <vs-dropdown-item @click="actionvm(vm.id, name='reboot-hard')" name="reboot-hard" value="reboot-hard">
                                <p class="text-left py-2 px-2 cursor-pointer hover:bg-primary hover:text-white"><i class="feather icon-loader mr-4 "></i>Reboot</p>
                              </vs-dropdown-item>
                              <vs-dropdown-item @click="actionvm(vm.id, name='poweroff-hard')" name="poweroff-hard" value="poweroff-hard">
                              ...
                              <vs-dropdown-item @click="actionvm(vm.id, name='resume')" name="resume" value="resume">
